...
/* This ensures all links in the sidebar never have underlines */
.sidebar .sub-menu a,
.sidebar .nav-item a {
    text-decoration: none !important;
}

/* Extra specificity to override any default styles */
                    ...
                    <div class="h-full bg-white dark:bg-[#0e1726]">
                        <div class="flex items-center justify-between px-4 py-3">
                            <a href="index.html" class="main-logo flex shrink-0 items-center">
                                <img class="inline w-48 ltr:-ml-1 rtl:-mr-1" src="<?php echo base_url(); ?>app/views/assets/img/logo.png" alt="Logo">
                            </a>
                        ...
                        <ul class="perfect-scrollbar relative h-[calc(100vh-80px)] space-y-0.5 overflow-y-auto overflow-x-hidden p-4 py-0 font-semibold" x-data="{ activeDropdown: 'dashboard' }">
                            ...
                            <ul x-cloak="" x-show="activeDropdown === 'dashboard'" x-collapse="" class="sub-menu text-gray-500">
                                <li>
                                    <a href="/dashboard" class="active no-underline flex items-center gap-3 px-4 py-2.5 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md">
                                ...
                                <li>
                                    <a href="/setting/view" class="no-underline flex items-center gap-3 px-4 py-2.5 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md">
                                        <svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                ...
                                <li>
                                    <a href="/form/view" class="no-underline flex items-center gap-3 px-4 py-2.5 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md">
                                        <svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                        ...
                                        <span class="font-medium">IBSC Form</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="/profile" class="no-underline flex items-center gap-3 px-4 py-2.5 transition-colors duration-200 hover:bg-gray-100 dark:hover:bg-gray-800 rounded-md">
                                        <svg class="w-5 h-5 text-indigo-600 dark:text-indigo-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
