...
<div class="container-fluid">
    <div class="table-responsive kra-table">
        <table class="table table-bordered table-sm">
            <thead>
                <tr class="table-yellow text-center">
                    <th colspan="22" style="text-align: center; vertical-align: middle; background-color: #FFEC19; color: #000; position: relative;">
                       LEARNING AND GROWTH (5%) - goals that bring the organization to the higher level of performance or state
                       <div class="action-btns" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%);">
                            <button id="addKRABtnLearning" class="btn btn-sm btn-primary" style="font-size: 9px; padding: 2px 5px;">
                                <i class="fas fa-plus"></i> Add New KRA
                            </button>
                            <button id="removeKRABtnLearning" class="btn btn-sm btn-danger ms-2"style="font-size: 9px; padding: 2px 5px;">
            ...
            <tbody id="goalBodyLearning">
                <!-- Template for KRA row - This will be used by JavaScript to create new rows -->
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="3">Sub Total</td>
                    <td id="weightTotalLearning">0.0%</td>
                    <td colspan="15"></td>
                    <td id="scoreTotalLearning" class="table-yellow text-center">#DIV/0!</td>
                    <td></td>
                    <td></td>
                </tr>
            </tfoot>
...
<template id="goalRowTemplateLearning">
