...
<div class="container-fluid">
    <div class="table-responsive kra-table">
        <table class="table table-bordered table-sm">
            <thead>
                <tr class="table-yellow text-center">
                    <th colspan="22" style="text-align: center; vertical-align: middle; background-color: #FFEC19; color: #000; position: relative;">
                        STRATEGIC OR CUSTOMER (10%) - goals that bring the organization to the higher level of performance or state
                        <div class="action-btns" style="position: absolute; right: 10px; top: 50%; transform: translateY(-50%);">
                            <button id="addKRABtnStrategic" class="btn btn-sm btn-primary" style="font-size: 9px; padding: 2px 5px;">
                                <i class="fas fa-plus"></i> Add New KRA
                            </button>
                            <button id="removeKRABtnStrategic" class="btn btn-ms btn-danger ms-2"style="font-size: 9px; padding: 2px 5px;">
            ...
            <tbody id="goalBodyStrategic">
                <!-- Template for KRA row - This will be used by JavaScript to create new rows but
                     the structure is defined here in HTML -->
            </tbody>
            <tfoot>
                <tr>
                    <td colspan="3">Sub Total</td>
                    <td id="weightTotalStrategic">0.0%</td>
                    <td colspan="15"></td>
                    <td id="scoreTotalStrategic" class="table-yellow text-center">#DIV/0!</td>
                    <td></td>
                    <td></td>
                </tr>
            </tfoot>
...
<template id="kraRowTemplateStrategic">
...
<template id="goalRowTemplateStrategic">
