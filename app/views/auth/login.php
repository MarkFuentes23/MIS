                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="/auth/login">
                                    <div class="form-group mb-3 position-relative">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="username" class="form-control form-control-user border-left-0" placeholder="Enter Username..." required>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3 position-relative">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text bg-transparent border-left-0" onclick="togglePassword()">
                                                    <i class="fas fa-eye text-primary" id="toggleIcon"></i>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-checkbox small">
                                            ...
                                            <label class="custom-control-label" for="rememberMe">
                                                <i class="fas fa-check-circle text-primary mr-1"></i>Remember Me
                                            </label>
                                        </div>
                                    </div>
                                ...
                                <div class="text-center">
                                    <a class="small text-primary" href="/auth/register">
